...
void setKalman(){
    ...
    k[0].dt=0.001;                                                                                                  //set Dt
    k[0].x.numbers[0][0]=0;      k[0].x.numbers[1][0]=0;                                                            //set x0
    k[0].A.numbers[0][0]=1;   k[0].A.numbers[0][1]=k[0].dt;     k[0].A.numbers[1][0]=0;   k[0].A.numbers[1][1]=1;   //set A
    k[0].B.numbers[0][0]=k[0].dt*k[0].dt/2;     k[0].B.numbers[1][0]=k[0].dt;                                       //set B
    k[0].P.numbers[0][0]=1;    k[0].P.numbers[0][1]=0;    k[0].P.numbers[1][0]=0;    k[0].P.numbers[1][1]=1;   //values either 1 or 0.1, to be decided
    k[0].H.numbers[0][0]=1;    k[0].H.numbers[0][1]=0;    k[0].H.numbers[1][0]=0;    k[0].H.numbers[1][1]=1;        //set H
    k[0].R.numbers[0][0]=0.2;    k[0].R.numbers[0][1]=0;    k[0].R.numbers[1][0]=0;    k[0].R.numbers[1][1]=0.2;    //set R
    
    
    
    //setting the South Kalman
    k[1].dt=0.001;                                                                                                  //set Dt
    k[1].x.numbers[0][0]=0;      k[1].x.numbers[0][1]=0;                                                            //set x0
    k[1].A.numbers[0][0]=1;   k[1].A.numbers[0][1]=k[1].dt;     k[1].A.numbers[1][0]=0;   k[1].A.numbers[1][1]=1;   //set A
    k[1].B.numbers[0][0]=k[1].dt*k[1].dt/2;     k[1].B.numbers[0][1]=k[1].dt;                                       //set B
    k[1].P.numbers[0][0]=1;    k[1].P.numbers[0][1]=0;    k[1].P.numbers[1][0]=0;    k[1].P.numbers[1][1]=1;   //values either 1 or 0.1, to be decided
    k[1].H.numbers[0][0]=1;    k[1].H.numbers[0][1]=0;    k[1].H.numbers[1][0]=0;    k[1].H.numbers[1][1]=1;        //set H
    k[1].R.numbers[0][0]=0.2;    k[1].R.numbers[0][1]=0;    k[1].R.numbers[1][0]=0;    k[1].R.numbers[1][1]=0.2;    //set R
    
    //setting the Down Kalman
    k[2].dt=0.001;                                                                                                  //set Dt
    k[2].x.numbers[0][0]=0;      k[2].x.numbers[0][1]=0;                                                            //set x0
    k[2].A.numbers[0][0]=1;   k[2].A.numbers[0][1]=k[2].dt;     k[2].A.numbers[1][0]=0;   k[2].A.numbers[1][1]=1;   //set A
    k[2].B.numbers[0][0]=k[2].dt*k[2].dt/2;     k[2].B.numbers[0][1]=k[2].dt;                                       //set B
    k[2].P.numbers[0][0]=1;    k[2].P.numbers[0][1]=0;    k[2].P.numbers[1][0]=0;    k[2].P.numbers[1][1]=1;   //values either 1 or 0.1, to be decided
    k[2].H.numbers[0][0]=1;    k[2].H.numbers[0][1]=0;    k[2].H.numbers[1][0]=0;    k[2].H.numbers[1][1]=1;        //set H
    k[2].R.numbers[0][0]=0.2;    k[2].R.numbers[0][1]=0;    k[2].R.numbers[1][0]=0;    k[2].R.numbers[1][1]=0.2;    //set R
}
...
Matrix *calc_acc_vec(Matrix *a, const float offsetx, const float offsety){
    ...
    rotation.numbers[1][0] = 2*(q1*q2 - q0*q3);
    rotation.numbers[2][0] = 2*(q1*q3 + q0*q2);
    rotation.numbers[0][1] = 2*(q1*q2 + q0*q3);
    rotation.numbers[1][1] = q0*q0 - q1*q1 + q2*q2 - q3*q3;
    rotation.numbers[2][1] = 2*(q1*q3 - q0*q1);
    rotation.numbers[0][2] = 2*(q1*q3 - q0*q2);
    rotation.numbers[1][2] = 2*(q2*q3 + q0*q1);
    rotation.numbers[2][2] = q0*q0 - q1*q1 - q2*q2 + q3*q3;
...
void compute_GPS(float lla[3], float x[3], float v[3]){
    ...
    for (int i=0; i<3; i++) {
        x[i] = k[i].x.numbers[0][0] + (lla[i] - last_lla[i]);
        v[i] = k[i].x.numbers[1][0] + (x[i] - k[i].x.numbers[0][0])/k[i].dt;
    }
...
/*============================================================================*/
void calculate_velocity(float* lla, Matrix *acc){ //passing latlongalt
    float x[3];
    float v[3];
    for (int i=0; i<3; i++) {
        x[i]=k[i].x_p.numbers[0][0];
        v[i]=k[i].x_p.numbers[0][1];
    }
    Matrix GPS=*constructor(1, 1);
    acc=calc_acc_vec(acc, 0, 0);
    
    //this piece of code works while the GPS retrieves data (the IMU works at 1800Hz, while the GPS works at 1 to 5Hz)
    if(lla[0]==-1 && lla[1]==-1 && lla[2]==-1){//can also be else if(lla[0]==lastlla[0] &&...&&...)
        for (int i=0; i<3; i++) {
            x[i]+=acc->numbers[0][i]*sampleFreq*sampleFreq;
            v[i]+=acc->numbers[0][i]*sampleFreq;
        }
    }
    ...
    for (int i=0; i<3; i++) {
        GPS.numbers[0][0]=lla[i];
        Kalman_Filter(&k[i], acc->numbers[0][i], &GPS);
    }
